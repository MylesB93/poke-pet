...
namespace PokePet.Core.Models
{
	...
	public class Pokemon
	{
		...
		public void LoadLastState()
		{
			...
			{
				Hunger = (Hunger)Math.Min((int)Hunger + minutesElapsed / 10, (int)Hunger.Starving);
				Tiredness = (Tiredness)Math.Min((int)Tiredness + minutesElapsed / 15, (int)Tiredness.Exhausted);
				Boredom = (Boredom)Math.Min((int)Boredom + minutesElapsed / 20, (int)Boredom.ReallyBored);
			}
